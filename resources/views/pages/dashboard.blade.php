        ...
        @if (session('message'))
            <div class="text-center mb-3">
                <div class="alert alert-dismissible fade show" role="alert"
                    style="background-color: {{ session('message_type') == 'success' ? '#28a745' : (session('message_type') == 'warning' ? '#ffc107' : '#dc3545') }}; color: #fff;">
                    {{ session('message') }}
        ...
        new Chart(document.getElementById('chartPenukaran'), {
            ...
            options: {
                ...
                scales: {
                    y: {
                        beginAtZero: true,
                        // Konfigurasi agar angka bulat
                        ticks: {
                            precision: 0 // Memastikan tidak ada angka koma
                        }
                    }
                }
            }
