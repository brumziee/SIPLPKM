...
@section('title', 'Kelola Riwayat Penukaran')

{{-- Diaktifkan apabila ingin menambahkan tombol tukar poin pelanggan pada page riwayat penukaran poin --}}
{{-- @section('action')
...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Daftar Riwayat Penukaran</h3>
        </div>
        <div class="card-body">
        ...
        $(document).ready(function() {
            ...
            $(document).on('submit', '.form-delete', function(e) {
                ...
                Swal.fire({
                    ...
                    html: "Apakah Anda yakin ingin menghapus data penukaran dari:<br><b>" +
                        namaData + "</b>?",
                    icon: 'warning',
